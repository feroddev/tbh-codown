...
RECOMMENDED_FARM_PRESET: dict[int, dict[str, object]] = {
    ...
    40: {
        ...
        "boss_key": "920401",
        "reason": "Menor HP entre mapas com Boss Lv40 (~12k).",
    },
    50: {
        "label": "1-1 Pasture (Hell)",
        "act": 1,
        "stage": 1,
        "difficulty": "Hell",
        "boss_key": "920501",
        "reason": "Menor HP entre mapas com Boss Lv50 (~15k).",
    },
    65: {
        ...
        "difficulty": "Hell",
        "boss_key": "920651",
        "reason": "Primeiro mapa Hell com Boss Lv65 — wiki.",
    },
    80: {
